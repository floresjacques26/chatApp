          ...
          children: [
            ...
            ConfirmButton(
              ...
              onPressed: () async {
                try {
                  ...
                  var user = await FirebaseAuthService().login(emailController.text, passwordController.text);
            ...
            Row(
              ...
              children: [
                ...
                AuthButton(
                  image: 'https://static.vecteezy.com/system/resources/previews/016/716/481/original/facebook-icon-free-png.png',
                ),
                AuthButton(
